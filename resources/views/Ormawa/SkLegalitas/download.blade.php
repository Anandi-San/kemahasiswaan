...
<div class="flex flex-col items-center">
    ...
    <div class="flex flex-col md:flex-row"> 
        <div id="boxToRemove" class="bg-customGray h-screen w-1/5 hidden md:block"> 
        </div>
        <div class="flex justify-between w-screen">
            ...
            <div class="bg-customGray h-screen w-full md:w-3/6"> 
                <img src="{{ asset('images/test.png') }}" alt="Test Image" class="max-w-full h-auto"> 
            </div>
            <div class="bg-customGray h-screen w-20 md:w-1/5 flex flex-col justify-between">
                ...
                <div class="flex items-center justify-center"> 
                    <button class="h-12 w-20 md:w-4/5 md:mr-0 mr-2 bg-customBlue text-white font-bold py-3 px-6 rounded mt-4 mb-6 text-sm">Download</button> 
                </div>
            </div>
        </div>
    </div>
