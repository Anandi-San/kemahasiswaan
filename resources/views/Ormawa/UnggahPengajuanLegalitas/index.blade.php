...
@section('content')
    ...
    {{-- <form action="{{ route('legalitas.upload', ['step' => 1]) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('post')
    </form> --}}

    <form action="{{ route('legalitas.upload') }}" method="post" enctype="multipart/form-data">
        @csrf
